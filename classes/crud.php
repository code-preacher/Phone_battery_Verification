...
// Inserting
	...
	public function addBattery($post,$file)
	{
		...
		$query="INSERT INTO battery(user_id,voltage,type,make,mdate,serial_number,other_data,image) VALUES ('$user_id','$voltage','$type','$make','$mdate','$serial_number','$other_data','$battery')";
		$sql = $this->con->query($query);
		if ($sql==true) {
